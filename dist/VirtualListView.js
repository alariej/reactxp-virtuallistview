    ...
    VirtualListView.prototype.render = function () {
        ...
        for (var _b = 0, cellList_1 = cellList; _b < cellList_1.length; _b++) {
            ...
            itemsRendered.push(RX.createElement(VirtualListCell_1.VirtualListCell, { ref: cell.cellInfo.cellRef, key: this._isAndroidScreenReaderEnabled() ? _accessibilityVirtualKeyPrefix +
                    cell.cellInfo.virtualKey : cell.cellInfo.virtualKey, onLayout: !cell.cellInfo.isHeightConstant ? this._onLayoutItem : undefined, onAnimateStartStop: this._onAnimateStartStopItem, itemKey: cell.item ? cell.item.key : undefined, item: cell.item, width: this._contentWidth, top: cell.cellInfo.top, isVisible: cell.cellInfo.isVisible, isActive: cell.item ? true : false, isFocused: isFocused, isSelected: isSelected, tabIndex: tabIndexValue, onItemFocused: this._onItemFocused, onItemSelected: this._onItemSelected, shouldUpdate: !this.props.skipRenderIfItemUnchanged || cell.cellInfo.shouldUpdate, showOverflow: this.props.showOverflow, isScreenReaderModeEnabled: this._isAndroidScreenReaderEnabled(), renderItem: this.props.renderItem, onKeyPress: this._onKeyDown }));
